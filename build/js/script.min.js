...
"use strict";var name="User Name",place="Flavortown";console.log("Hello "+name+", ready for "+place+"?");var sliderControls=document.querySelector(".reviews__slider-controls"),sliderControl=document.querySelectorAll(".slider__control"),sliderList=document.querySelector(".reviews__list");sliderControls.addEventListener("click",function(e){var t=e.target;if(!t.classList.contains("active")){for(var l=0;l<sliderControl.length;l++)sliderControl[l].classList.remove("active");var r=t.dataset.test;console.log(r),sliderList.style.left="0",sliderList.style.left=-100*r+"%",t.classList.add("active")}}),$(document).ready(function(){$(".nav__link").click(function(){var e=$(this).attr("href");return 0!=$(e).length&&$("html, body").animate({scrollTop:$(e).offset().top},500),!1})});